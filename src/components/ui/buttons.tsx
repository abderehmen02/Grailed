...
return <button disabled={loading} className={cn( "px-6 py-2 flex items-center gap-2 text-sm border-black border-2" , {"opacity-65 bg-gray-400" : loading} ,className)} {...btnProps}  >
<div>{children}</div> { loading &&  <LoadingSpinner/>}
</button>
}
