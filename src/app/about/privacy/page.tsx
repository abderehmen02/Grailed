...
const page = () => {
  return (
    <div>
      <>
        <Header />
        <div className="px-4 py-8 mx-auto max-w-[900px] sm:px-16">
          <h2 className="text-[22px] sm:text-[30px] font-bold">
            Grailed Privacy Notice
          </h2>
          <p className="text-[10px]">Last Updated: November 6, 2023</p>
          <p>
            This Privacy Notice describes how Grailed, LLC with its principal
            place of business at 131 Spring Street, 6th Floor, New York, NY
            10012 (<span className="font-bold">&quot;Grailed&quot;,</span> <span className="font-bold">&quot;we&quot;,</span> <span className="font-bold"> &quot;our&quot;</span>or <span className="font-bold"> &quot;us&quot;</span> ) collects, uses and discloses
            information about you when you use our website at www.grailed.com
            (the <span className="font-bold">&quot;Site&quot;</span> ), mobile app, and other online products and services
            that link to this Privacy Notice, contact our customer service team,
            engage with us on social media, or otherwise interact with us
            (collectively with the Site, the <span className="font-bold">&quot;Services&quot;</span> ).
          </p>
          <h3 className="text-[16px] sm:text-[18px] font-bold"> WHAT INFORMATION DO WE COLLECT FROM YOU?
          </h3>
          <p className="text-[14px]">We collect personal information about you in connection with your use of our Services. This collection includes information that you may provide in connection with the Services, information from third parties, and information that is collected automatically such as through the use of cookies and other technologies. The information we gather enables us to provide, personalize, improve and continue to operate the Services. We collect the following types of information from our users:

          </p>
          <h3 className="text-[16px] sm:text-[16px] font-bold underline underline-offset-4 py-2"> Information You Provide to Us

          </h3>
          <p className="text-[14px]  py-2">We collect personal information from you. The categories of information we collect can include:

          </p>
          <ul className="list-disc pl-5 space-y-2">
            <li>
            <span className="font-bold">   Account and Profile Information,</span>
 ...
 <h3 className="text-[16px] sm:text-[16px] font-bold underline underline-offset-4 py-2">Personal Information Automatically Collected
          ...
          <p>
          For more information about these practices and your choices regarding cookies, please see our  <a className="text-[blue]" href="https://www.grailed.com/about/privacy/cookie-notice">Cookie Policy.</a>
